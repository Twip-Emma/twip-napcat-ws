...
@save_img.handle()
@is_level_S
async def save_img_handle(bot: Bot, event: MessageEvent, state: T_State, cost=20):
...
@record_pool.handle()
@is_level_S
async def record_pool_handle(bot: Bot, event: Event, state: T_State, cost=20):
...
@record_help.handle()
@is_level_S
async def record_help_handle(bot: Bot, event: Event, state: T_State, cost=20):
...
@is_level_S
async def delete_record_handle(bot: Bot, event: Event, state: T_State, cost=20):
...
@alltag.handle()
@is_level_S
async def alltag_handle(bot: Bot, event: Event, state: T_State, cost=20):
...
@addtag.handle()
@is_level_S
async def addtag_handle(bot: Bot, event: Event, state: T_State, cost=20):
...
@deltag.handle()
@is_level_S
async def deltag_handle(bot: Bot, event: Event, state: T_State, cost=20):
...
@make_record.handle()
@is_level_S
async def make_record_handle(bot: Bot, event: MessageEvent, state: T_State, cost=20):
...
@render_quote.handle()
@is_level_S
async def render_quote_handle(bot: Bot, event: MessageEvent, state: T_State, cost=20):
...
@script_batch.handle()
@is_level_S
async def script_batch_handle(bot: Bot, event: Event, state: T_State, cost=20):
...
@copy_batch.handle()
@is_level_S
async def copy_batch_handle(bot: Bot, event: Event, state: T_State, cost=20):
