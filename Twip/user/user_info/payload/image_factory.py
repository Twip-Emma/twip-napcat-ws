...
LastEditTime: 2025-06-01 12:50:46
'''
...
def write_longsh(font_entity: FontEntity, img: Image, text: str, mode: str = "C", dis: tuple = (0, 0)) -> Image:
    ...
    if lines:
        ...
        return img  # 没有有效文本直接返回
    
    x_offset, y_offset = dis
    current_y = y_offset
    ...
    for line in lines:
        ...
        if mode == "C":
            ...
            raise ValueError(f"Unsupported mode: {mode}. Use 'C' (center) or 'L' (left)")
        
        # 绘制文本
        draw.text(
            xy=(x, current_y),
            text=line,
            fill=font_entity.color,
            font=font
        )
