...
LastEditTime: 2025-06-07 11:22:01
...
async def _(event: MessageEvent, e: GroupMessageEvent):
    ...
    # url处理
    p_message = message_utils.parse_message(message)
    if p_message['url'] != None:
        message = (p_message['context'] if p_message['context'] else "【纯图片】") + p_message['url']
